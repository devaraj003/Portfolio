...
function changeProgress(button) {
    ...
    if (button === 'X') {
        ...
        document.getElementById('progress1').style.width = '85%';
        ...
        document.getElementById('progress3').style.width = '92%';
    } else if (button === 'Z') {
        ...
        document.getElementById('progress2').style.width = '92%';
        document.getElementById('heading3').innerText = 'Professional Development';
        document.getElementById('progress3').style.width = '88%';
    }
}